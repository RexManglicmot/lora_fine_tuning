...
#         return
#     plt.figure(figsize=(6,4))
#     plt.plot(np.arange(1, len(curve)+1), curve, marker="o")
#     plt.xlabel("Epoch")
#     plt.ylabel("Val Macro-F1")
#     plt.title(f"Validation Macro-F1 per Epoch (LoRA r={r})")
#     plt.ylim(0, 1.0)
...
#     _ensure_dir(metrics_dir); _ensure_dir(figs_dir)

#     # Required plots
#     plot_macro_f1_by_method(metrics_dir / "results.csv", figs_dir / "macro_f1_by_method.png")
...
#     #added 9/29
#     # NEW: two additional plots
#     plot_train_val_loss(metrics_dir, figs_dir / "train_val_loss_per_epoch.png")
#     plot_val_accuracy(metrics_dir, figs_dir / "train_val_accuracy_per_epoch.png")
#     #END
    
#     plot_latency_dist_if_exists(metrics_dir, figs_dir / "latency_distribution.png")


#     print("[plot_results] Saved figures to", figs_dir)
